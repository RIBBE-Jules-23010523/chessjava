...
/**
 * Cette classe représente un fou dans le jeu d'échecs.
 */
public class Bishop extends Piece {
     ...
     */
    public Bishop(String name, String color, int pieceColor, int locationX, int locationY) {
        super(name, color, pieceColor, locationX, locationY);
    }

    /**
     * Cette méthode retourne les mouvements valides du fou.
     * @param board l'échiquier.
     * @return un tableau des mouvements valides.
     * Le fou peut se déplacer en diagonale dans n'importe quelle direction.
     */
    ...
    /**
     * Cette méthode vérifie si un mouvement est valide pour le fou.
    ...
    /**
     * Cette méthode retourne la représentation en chaîne de caractères du fou.
     * @return la représentation en chaîne de caractères du fou.
     */
    @Override
